...
For `DATABASE_URL`, you can use a local SQLite database for development by omitting this variable (Django will default to `db.sqlite3`), or connect to a PostgreSQL instance (e.g., via [Neon](https://neon.tech)).
